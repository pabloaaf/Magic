...
<html>
	<head>
		...
		<script>
			...
			$(document).ready(function(){
				$("#frase").delay(13000).animate({opacity: '0'}, 8000);
				$("#saludo").delay(2000).animate({opacity: '0'}, 2000);
			});
		</script>
	</head>
	...
	echo "<div id='saludo' style='position:absolute;height:99%;width:99%;background:black;'> <h1 style='font-size:48px;position:relative'> Hola, ".$nombre."</h1></div>";
	?>

			<table align="left">
			 	<caption>Fecha y hora<hr></caption>
			 	<tr>
			    		<td class="reloj" style="position: relative;text-align: center;">
						<?php 
						if ($reloj_booleano == 1) {
							switch ($reloj_tipo) {
							case 1:
			...
			<div style="position: absolute;bottom: 0; right: 0;">
						<p><?php $shell = exec("hostname -I");
						echo $shell;?></p>
						<p><?php echo $_REQUEST['codigo'];?></p>
			</div>
	</body>
</html>
